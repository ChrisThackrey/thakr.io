...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      // Responsive padding: Tighter on mobile, more space on sm screens and up.
      className={cn("pt-2 px-2 sm:pt-3 sm:px-3 w-full h-full flex flex-col", className)}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 flex-grow",
        // Responsive vertical space between month caption and the day grid.
        month: "space-y-1 sm:space-y-2 flex flex-col flex-1",
        ...
        // Responsive vertical space (margin-top) for each row of days.
        row: "flex w-full mt-0.5 sm:mt-1 flex-1",
