  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-background font-sans antialiased">
        <ThemeProvider
          attribute="class" // Essential: tells next-themes to use class strategy
          defaultTheme="light" // Or "system" or "dark"
          enableSystem={true} // Allows "system" option
          disableTransitionOnChange // Usually false unless all transitions are custom and you want to prevent next-themes' own brief flash
        >
          <PageBackground />
          <SectionBackground />
